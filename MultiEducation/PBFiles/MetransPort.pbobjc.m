...
@implementation MetransPortRoot
...
#pragma mark - MetransPortRoot_FileDescriptor

static GPBFileDescriptor *MetransPortRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[CmdSignPb class]
                                     rootClass:[MetransPortRoot class]
                                          file:MetransPortRoot_FileDescriptor()
                                        fields:fields
