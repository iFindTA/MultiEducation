...
@dynamic studentArchivesPbArray, studentArchivesPbArray_Count;

typedef struct GuStudentArchivesListPb__storage_ {
  uint32_t _has_storage_[1];
  NSMutableArray *studentArchivesPbArray;
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "studentArchivesPbArray",
        .dataTypeSpecific.className = GPBStringifySymbol(GuStudentArchivesPb),
        .number = GuStudentArchivesListPb_FieldNumber_StudentArchivesPbArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(GuStudentArchivesListPb__storage_, studentArchivesPbArray),
    ...
    static const char *extraTextFormatInfo =
        "\001\001\000studentArchivesPb\000";
